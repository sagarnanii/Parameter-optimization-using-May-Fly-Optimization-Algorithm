...
```bash
git clone https://github.com/<sagarnanii>/Parameter-optimization-using-May-Fly-Optimization-Algorithm.git
cd Parameter-optimization-using-May-Fly-Optimization-Algorithm
```
